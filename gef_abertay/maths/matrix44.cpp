...
namespace gef {
	const Matrix44 Matrix44::kIdentity = { 1.f, 0.f, 0.f, 0.f, 0.f, 1.f, 0.f, 0.f, 0.f, 0.f, 1.f, 0.f, 0.f, 0.f, 0.f, 1.f };
	const Matrix44 Matrix44::kZero = { 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f };
	...
	Matrix44::Matrix44(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, float m20, float m21, float m22, float m23, float m30, float m31, float m32, float m33) {
		values_[0] = Vector4(m00, m01, m02, m03);
		values_[1] = Vector4(m10, m11, m12, m13);
		values_[2] = Vector4(m20, m21, m22, m23);
		values_[3] = Vector4(m30, m31, m32, m33);
	}

	Matrix44::Matrix44(const gef::Vector4 &position) {
		values_[0] = Vector4(1, 0, 0, 0);
		values_[1] = Vector4(0, 1, 0, 0);
		values_[2] = Vector4(0, 0, 1, 0);
		values_[3] = Vector4(position.x(), position.y(), position.z(), 1);
	}

	Matrix44::Matrix44(const gef::Quaternion &rotation) {
		Rotation(rotation);
	}
