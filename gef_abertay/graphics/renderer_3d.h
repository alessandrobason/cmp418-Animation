...
//		virtual void DrawPrimitive(const  MeshInstance& mesh_instance, Int32 primitive_index, Int32 num_indices = -1) = 0;
		...
		void DrawSkinnedMesh(const  MeshInstance& mesh_instance, const gef::Vec<Matrix44>& bone_matrices, bool use_default_shader = true);
		...
		static Renderer3D* Create(Platform& platform, IAllocator *alloc = g_alloc);
